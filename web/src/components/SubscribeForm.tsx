            ...
            <div className="pricing-grid">
                ...
                <div className="pricing-card basic">
                    ...
                    <form onSubmit={(e) => handleSubscribe('basic', e)} className="mt-auto pt-4">
                        <button type="submit" className="btn-secondary w-full flex items-center justify-center gap-2" style={{ width: '100%', marginTop: '1rem' }} disabled={loading}>
                            {loading ? (
                                <>
                ...
                <div className="pricing-card pro">
                    ...
                    <form onSubmit={(e) => handleSubscribe('pro', e)} className="mt-auto pt-4">
                        <button type="submit" className="btn-primary w-full flex items-center justify-center gap-2" style={{ width: '100%', marginTop: '1rem' }} disabled={loading}>
                            {loading ? (
                                <>

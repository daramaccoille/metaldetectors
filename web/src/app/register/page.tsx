    ...
    <main className="main-layout">
      ...
      <div className="glass-panel" style={{ width: '100%', maxWidth: '450px', padding: '2.5rem 2rem', zIndex: 10 }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1 className="hero-title" style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>Create Account</h1>
          <p className="hero-subtitle" style={{ fontSize: '1rem', margin: 0 }}>Join Metal Detectors</p>
        </div>
        ...
        <form action={onSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div>
            <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: '#9ca3af', marginBottom: '0.5rem' }}>Name</label>
            <input 
              type="text" 
              name="name" 
          ...
          <div>
            <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: '#9ca3af', marginBottom: '0.5rem' }}>Password</label>
            <input 
              type="password" 
              name="password" 
              placeholder="••••••••" 
        ...
        <div style={{ marginTop: '2rem', textAlign: 'center', fontSize: '0.875rem', color: '#71717a' }}>
          Already have an account? <Link href="/login" style={{ color: '#eab308', textDecoration: 'none', marginLeft: '0.25rem' }}>Sign in</Link>
        </div>
      </div>
    </main>
  )
